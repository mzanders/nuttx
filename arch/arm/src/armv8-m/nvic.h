...
#define NVIC_IRQ240_271_ENABLE_OFFSET   0x0120 /* IRQ 240-271 set enable register */
...
#define NVIC_IRQ240_271_CLEAR_OFFSET    0x01a0 /* IRQ 240-271 clear enable register */
...
#define NVIC_IRQ240_271_PEND_OFFSET     0x0220 /* IRQ 240-271 set pending register */
...
#define NVIC_IRQ240_271_CLRPEND_OFFSET  0x02a0 /* IRQ 240-271 clear pending register */
...
#define NVIC_IRQ240_271_ACTIVE_OFFSET   0x0320 /* IRQ 240-271 active bit register */
...
#define NVIC_IRQ240_271_TARGET_OFFSET   0x03a0 /* IRQ 240-271 target non-secure register */
...
#define NVIC_IRQ240_243_PRIORITY_OFFSET 0x04f0 /* IRQ 240-243 priority register */
#define NVIC_IRQ244_247_PRIORITY_OFFSET 0x04f4 /* IRQ 244-247 priority register */
#define NVIC_IRQ248_251_PRIORITY_OFFSET 0x04f8 /* IRQ 248-251 priority register */
#define NVIC_IRQ252_255_PRIORITY_OFFSET 0x04fc /* IRQ 252-255 priority register */
#define NVIC_IRQ256_259_PRIORITY_OFFSET 0x0500 /* IRQ 256-259 priority register */
#define NVIC_IRQ260_263_PRIORITY_OFFSET 0x0504 /* IRQ 260-263 priority register */
#define NVIC_IRQ264_267_PRIORITY_OFFSET 0x0508 /* IRQ 264-267 priority register */
#define NVIC_IRQ268_271_PRIORITY_OFFSET 0x050c /* IRQ 268-271 priority register */
...
#define NVIC_IRQ240_271_ENABLE          (ARMV8M_NVIC_BASE + NVIC_IRQ240_271_ENABLE_OFFSET)
...
#define NVIC_IRQ240_271_CLEAR           (ARMV8M_NVIC_BASE + NVIC_IRQ240_271_CLEAR_OFFSET)
...
#define NVIC_IRQ240_271_PEND            (ARMV8M_NVIC_BASE + NVIC_IRQ240_271_PEND_OFFSET)
...
#define NVIC_IRQ240_271_CLRPEND         (ARMV8M_NVIC_BASE + NVIC_IRQ240_271_CLRPEND_OFFSET)
...
#define NVIC_IRQ240_271_ACTIVE          (ARMV8M_NVIC_BASE + NVIC_IRQ240_271_ACTIVE_OFFSET)
...
#define NVIC_IRQ240_271_TARGET          (ARMV8M_NVIC_BASE + NVIC_IRQ240_271_TARGET_OFFSET)
...
#define NVIC_IRQ240_243_PRIORITY        (ARMV8M_NVIC_BASE + NVIC_IRQ240_243_PRIORITY_OFFSET)
#define NVIC_IRQ244_247_PRIORITY        (ARMV8M_NVIC_BASE + NVIC_IRQ244_247_PRIORITY_OFFSET)
#define NVIC_IRQ248_251_PRIORITY        (ARMV8M_NVIC_BASE + NVIC_IRQ248_251_PRIORITY_OFFSET)
#define NVIC_IRQ252_255_PRIORITY        (ARMV8M_NVIC_BASE + NVIC_IRQ252_255_PRIORITY_OFFSET)
#define NVIC_IRQ256_259_PRIORITY        (ARMV8M_NVIC_BASE + NVIC_IRQ256_259_PRIORITY_OFFSET)
#define NVIC_IRQ260_263_PRIORITY        (ARMV8M_NVIC_BASE + NVIC_IRQ260_263_PRIORITY_OFFSET)
#define NVIC_IRQ264_267_PRIORITY        (ARMV8M_NVIC_BASE + NVIC_IRQ264_267_PRIORITY_OFFSET)
#define NVIC_IRQ268_271_PRIORITY        (ARMV8M_NVIC_BASE + NVIC_IRQ268_271_PRIORITY_OFFSET)
