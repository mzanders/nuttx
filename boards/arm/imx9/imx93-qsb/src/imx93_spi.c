/****************************************************************************
 * boards/arm/imx9/imx93-qsb/src/imx93_spi.c
 *
...
int imx93_lpspi_cmddata(struct spi_dev_s *dev, uint32_t devid, bool cmd)
{
  return -ENODEV;
}
#endif
